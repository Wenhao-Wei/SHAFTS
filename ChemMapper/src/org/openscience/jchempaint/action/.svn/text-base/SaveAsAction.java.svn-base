...
public class SaveAsAction extends JCPAction
{
    ...
    public void saveRenderFileAsMol(IChemModel model, String fileName) throws Exception{
    	if (renderFile == null) renderFile = new File(fileName);
    	if (model != null && fileName != null)
    		saveAsMol(model, renderFile);
    }
